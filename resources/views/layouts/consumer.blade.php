...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100 pb-[300px]">
        ...
        {{-- <nav class="bg-white border-gray-200 dark:bg-gray-900">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Farmify</span>
                </a>
                    ...
                    <ul
                        ...
                        <li>
                            <a href="{{ route('consumer.dashboard') }}"
                                class="block py-2 px-3 text-green-500 bg-green-500 rounded md:bg-transparent md:text-green-500 md:p-0"
                                aria-current="page">Home</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 px-3 text-gray-900 rounded hover:bg-green-500 md:hover:bg-transparent md:hover:text-green-500 md:p-0 ">About</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 px-3 text-gray-900 rounded hover:bg-green-500 md:hover:bg-transparent md:hover:text-green-500 md:p-0 ">Services</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 px-3 text-gray-900 rounded hover:bg-green-500 md:hover:bg-transparent md:hover:text-green-500 md:p-0 ">Pricing</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 px-3 text-gray-900 rounded hover:bg-green-500 md:hover:bg-transparent md:hover:text-green-500 md:p-0">Contact</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a
                            href="https://flowbite.com/" class="hover:underline">Farmify™</a>. All Rights Reserved.
                    </span>
