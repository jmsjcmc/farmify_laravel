        ...
        <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
            ...
            <form action="{{ route('consumer.jobs.apply', $job->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex items-center space-x-2 rounded-b border-t border-gray-200 p-6 dark:border-gray-600">
                    <button type="submit" class="rounded-lg bg-green-500 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-green-300">
                        Submit Application
                    </button>
