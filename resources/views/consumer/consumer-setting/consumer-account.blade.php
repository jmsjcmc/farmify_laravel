                    ...
                    <div class="space-y-4">
                        <div class="flex space-x-4">
                            <img class="h-16 w-16 rounded-lg"
                                ...
                                alt="User Avatar"
                                onerror="this.src='{{ asset('storage/images/profile/default-avatar.png') }}'" />
                            <div>
                                <span
                                ...
                                <button
                                    class="flex items-center rounded-lg bg-green-500 border px-3 py-1 text-white hover:bg-neutral-50 hover:text-green-500">
                                    <a href="{{ route('consumer.setting') }}"><span class="text-sm font-bold">Edit
                    ...
                    <div class="space-y-4">
                        ...
                        <dl>
                            ...
                            <dd class="flex items-center space-x-4 text-gray-500 dark:text-gray-400">
                                ...
                                <div>
                                    <div class="text-sm">
                                        <p class="mb-0.5 font-medium text-gray-900 dark:text-white">Visa ending in 7658
                                        </p>
