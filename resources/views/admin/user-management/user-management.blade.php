        ...
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
            ...
            <li class="me-2">
                <a href="#" id="farm-owners-tab" onclick="showTab('farm-owners')"
                    class="inline-flex items-center justify-center p-4 text-green-500 border-b-2 border-green-500 rounded-t-lg active dark:text-green-500 dark:border-green-500 group"
                    aria-current="page">
                        <svg class="w-4 h-4 me-2 text-green-500 dark:text-green-500" aria-hidden="true"
