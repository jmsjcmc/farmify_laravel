...
<div class="border-b border-gray-200 dark:border-gray-700">
    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
        <li class="me-2">
            <a href="#" id="users-tab" onclick="showTab('users')" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group">
        ...
        <li class="me-2">
            <a href="#" id="farm-owners-tab" onclick="showTab('farm-owners')" class="inline-flex items-center justify-center p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 group" aria-current="page">
        ...
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                <div class="mb-4">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage and organize your users from this
                        dashboard</p>
                </div>
        ...
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                <div class="mb-4">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage and organize your farm owners from this
                        dashboard</p>
                </div>
                                    ...
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex flex-col">
                                                ...
                                                <span class="text-xs">Size: {{ $farmOwner->farm_size }} | Type: {{ $farmOwner->farm_type }}</span>
                                            </div>
                                        </td>
                                        <td class="px-4 py-3">
                                            <div class="flex flex-col">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex flex-col">
                                                <div class="mb-1">
                                                    ...
                                                    <span class="text-xs">{{ $farmOwner->business_permit_number }}</span>
                                                ...
                                                <div>
                                                    <span class="text-xs font-medium">{{ $farmOwner->valid_id_type }}:</span>
