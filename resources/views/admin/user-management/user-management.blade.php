        ...
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                <div class="mb-4">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage and organize your users from this dashboard</p>
                </div>

                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                        <div x-data="{ search: '{{ request('search') }}' }" class="w-full md:w-1/2">
                            <form action="{{ route('admin.user-management') }}" method="GET" class="flex items-center">
                        ...
                        <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                            <button type="button" data-modal-target="userModal" data-modal-toggle="userModal" class="flex items-center justify-center text-white border bg-green-500 hover:bg-neutral-50 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $user->first_name}} {{ $user->last_name}}</th>
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div id="user-{{ $user->id }}-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                                                ...
                                                <li>
                                                    <button type="button" data-modal-target="userModal" data-modal-toggle="userModal" data-user-id="{{ $user->id }}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</button>
                                                    {{-- <a href="#" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a> --}}
                                                </li>
                                            </ul>
                                            <div class="py-1">
